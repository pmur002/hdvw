...
kable(head(crimeType2021[c("type", "count")]), digits=3)
```
...
For example, we can decode that theft is about twice as common as the next
...
is visually roughly one quarter of the distance
...
similar to the difference between Miscellaneous and crimes Against justice,
