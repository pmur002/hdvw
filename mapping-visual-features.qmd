...
In this section, we start with a very simple sort of mapping.
...
In terms of **decoding** (@fid-decode),
...
The difficulty only increases with irregular
arrangements,
...
[^pattern-capacity]:
    ...
    Tremmel (1995) only provides guidance for three different patterns
