...
**TODO**
Need diagram showing encoding congruent with learned decoding
(@sec-learned?)
and one showing encoding dissonant with learned encoding
e.g., use wrong flag for country!
(@sec-learned-danger)
...
to country (@fig-data-obj-decode).
