...
In that case, the decoding of the combination be reduced to
...
@fig-separable shows several other cases. For example, the 
...
However, in the specific case of decoding correlation from a scatter plot,
experiments have shown that decoding is reasonably accurate.[^emergent-accuracy]

[^emergent-accuracy]:
    Examples of studies that demonstrate accuracy for decoding
    correlation, althouhg with a tendency to underestimate,
