...
**TODO** 
refer back to @sec-cartesian and @sec-ternary.
Get emergent feature of position within triangle
from interaction of three position encodings
([Combining Mappings](combine.html))
=> overall proportion combination retrievable
...
[^compatibility-principle]:
    This is the "proximity compatibility principle" ? of Carswell and Wickens ?
...
Especially chroma and luminance.
Can successfully vary hue separately from the others (@sec-divergent).
Is this an example of integrating ineffectively?
Refer back to @sec-escape.
...
**TODO**
one argument against redundancy is that each individual feature
may not be as effective as it would be on its own because
it is not the ONLY change happening.
Example is the colour and size used in Fig 2 of letter-value plots
Hofmann et al
