...
## One big idea: Encodings {#sec-encodings}
...
In other words, each cell of @tbl-crime is encoded to its own coloured rectangle.
...
that it uses to present data values as data symbols.
