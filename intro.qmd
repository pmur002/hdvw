...
[^mappings]: 
    ...
    of *mappings* from data values to visual representations aligns
    with ideas from the *Grammar of Graphics* [@wilkinson2005].

The most obvious mapping in a data visualisation involves the
mapping of **data values** to **data symbols** (@fig-mappings).
...
A data visualisation can be described by the mappings that it employs
