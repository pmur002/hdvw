...
than comparing the ranges of scores.
...
For example, @fig-boxplot allows us to compare the interquartile ranges
more easily because a boxplot encodes that information directly as the
length of a box.

**TODO**
express the uncertaintly directly in a variety of ways
dynamite plots?
linear gradients?
