...
## Learned mappings of text {#sec-learned-text}
...
## Mapping information {#sec-labels}
...
**data symbols**.
The mappings in @fig-wordcloud include encoding each word as the **pattern** of 
a text data symbol and encoding frequency as the **size**
of a text data symbol.
There is no need for a guide for the mapping from words to text pattern because
