...
compar data values from text symbols
than it does to compare data values from simple visual features.
...
gg <- ggplot(temp) + 
    ...
    geom_segment(aes(x=-Inf, y=team, xend=Inf, yend=team),
                 linetype="dotted") +
    geom_point(aes(x=scored, y=team, fill=hemisphere), size=4,
