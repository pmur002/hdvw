...
globally.[^statista]
The data symbols in this plot are images of a cat and a dog,
with the number of pets mapped to the height of each image.
...
Footnote:  different terminology icons, glyphs, pictograms
