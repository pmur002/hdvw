...
* add fovea and rods and cones to visual-model.qmd

* add gestalt to visual-model.qmd ?
  => get to call on it when discussing scatter plots for identifying
     clusters (and in other places too) ?
  pre-attentive pop out too ?
...
* attention
  Put foveal and saccades in here?
  Put (CRAP) contrast in here?
...
* facetting!
  Could go in a "big data" section?
  Or possibly a multivariate section?
