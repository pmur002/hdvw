...
## Non-linear scales {#sec-non-linear}
...
[^info-vis-ref-model]:
  ...
  PLUS the design-centric extension by Wu and Chang (2024),
...
using luminance for quant, but not trying for accurate decoding
of individual data values,
BUT mention effectiveness of luminance in heatmap for ensemble perception
of regions?
...
Why si a picture is worth a thousand words?
