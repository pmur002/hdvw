...
@fig-group-angle shows that this effect also works
for other visual features, in this case **angle**.
...
than it is to see groups of different angles.
There is also a single teal plus shape in both @fig-group-colour-angle-1
and @fig-group-colour-angle-2, but these are much harder to find 
than the single teal item in @fig-pop-colour or the single plus shape
in @fig-pop-angle.
...
groups also formed based on proximity and connectivity.[^gestalt]
...
(see @sec-visual-summary) of **position in space** 
