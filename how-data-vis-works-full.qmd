...
Use bar plot from 787resources/Examples/2025-05-TMR-axis-flip/

The issue is that the x-axis labelling (vertically) swaps tick mark
labels with text data symbols showing heights of bars
(because first couple of bars are negative).

The host, Emma Vigeland, actually confuses the labels and goes from
-$1,000 to $4.3M, which should of course be -$1,000 to $389.3K"
