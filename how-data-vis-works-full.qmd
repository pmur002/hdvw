...
**TODO** Discuss the pros and cons of using visual objects.

Can refer to visual-model to make the argument *against* based on
the benefits of using simple shapes, basic visual features, and
only changing visual features based on changes in the data, while
keeping everything else constant.

OTOH, there are arguments for engagement, attention, and memorability.

This section can then inform the case studies.
...
which provides a better mapping *back* to data values,
although area is still not the most accurate and the lengths
