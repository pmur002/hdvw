...
to a person with severe deuteranopia.  
...
to a viewer with severe deuteranopia.  The difference in hue
...
When an learned encoding exists,
...
the decoding is **congruent** with the learned decoding, in the sense
that the learned decoding leads back to the original data values
...
**TODO** link back to "good gestalt"/simplicity in visual model
