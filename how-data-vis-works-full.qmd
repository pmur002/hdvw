...
For example, in @fig-pop-1 we can detect the one teal point amongst the
19 orange points without effort. @fig-pop-2 shows that this task remains
...
A feature of @fig-pop is that only one basic feature is changing: **colour**.
...
complex difference hard to detect (orange circle within blue and orange
