grid.newpage()
features <- c("position", "length", "angle", "area", "hue", 
              "chroma", "luminance", "pattern")
...
grid.rect(gp=gpar(fill="white", lwd=3))
pushViewport(viewport(width=.8, height=.8))
w <- rep(seq(.05, .15, length.out=4), 4)
h <- rep(seq(.15, .05, length.out=4), each=4)
grid.rect(rep(1:4/5, 4), rep(1:4/5, each=4), w, h,
          gp=gpar(fill="black"))
popViewport(3)
...
grid.rect(gp=gpar(fill="white", col=NA))
pushViewport(viewport(width=.8, height=.8))
cols <- rep(hcl(c(0, 90, 180, 270), 50, 70), 4)
l <- seq(.05, .15, length.out=4)
grid.rect(rep(1:4/5, 4), rep(4:1/5 - l/2, each=4), .05, rep(l, each=4),
          just="bottom",
          gp=gpar(col=cols, fill=cols))
popViewport(3)
...
for (j in 1:4) {
    for (i in 4:1) {
        ...
        grid.define(pointsGrob(.5, .5, size=unit(2, "mm"), pch=j,
                               gp=gpar(lwd=1)), name=name)
        pushViewport(viewport(j/5, i/5, width=1, height=l[5 - i]/max(l)))
        grid.use(name)
        popViewport()
    }
}
...
grid.points(rep(1:4/5, 4), rep(4:1/5, each=4), size=rep(unit(w, "mm"), each=4),
            pch=pch, gp=gpar(lwd=1))
popViewport(3)
## Hue
...
cols[1, ] <- hcl(c(0, 90, 180, 270), 50, 70)
cols[, 1] <- hcl(c(0, 90, 180, 270), 50, 70)
rgb <- col2rgb(hcl(c(90, 180, 270), 50, 70))/255
...
grid.rect(gp=gpar(fill="white", lwd=1))
pushViewport(viewport(width=.9, height=.9))
cols <- hcl(rep(c(0, 90, 180, 270), each=4), rep(4:1/5*100, 4), 70)
grid.circle(rep(1:4/5, 4), rep(4:1/5, each=4), unit(1, "mm"),
            gp=gpar(col=cols, fill=cols))
popViewport(3)
...
grid.rect(gp=gpar(fill="white", lwd=1))
pushViewport(viewport(width=.9, height=.9))
cols <- hcl(rep(c(0, 90, 180, 270), each=4), 50, rep(4:1/5*100, 4))
grid.circle(rep(1:4/5, 4), rep(4:1/5, each=4), unit(1, "mm"),
            gp=gpar(col=cols, fill=cols))
popViewport(3)
...
pushViewport(viewport(width=.9, height=.9))
cols <- hcl(c(0, 90, 180, 270), 50, 70)
grid.points(rep(1:4/5, 4), rep(4:1/5, each=4), size=unit(2, "mm"), pch=pch,
            gp=gpar(lwd=1.5, col=rep(cols, each=4)))
popViewport(3)
## Chroma
...
cols <- hcl(0, 4:1/5*100, 70)
grid.points(rep(1:4/5, 4), rep(4:1/5, each=4), size=unit(2, "mm"), pch=pch,
            gp=gpar(lwd=1.5, col=rep(cols, each=4), fill=rep(cols, each=4)))
popViewport(3)
## Luminance
