...
(see @fig-eye).
A large amount of visual information is gathered by the 
eye and passed on to the brain.

There are two types of light-sensitive nerve cells in the retina:
cones are colour-sensitive and very dense at the fovea, where the
centre of view is projected;  rods are monochromatic,
only sensing the amount of light,
and are less densely spread at the edges of the retina, which
corresponds to peripheral vision.
