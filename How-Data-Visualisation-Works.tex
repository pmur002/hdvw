...
visually average the \textbf{positions} of the data points.\footnote{The
  ...
  known as \emph{ensemble perception}. Cui and Liu (2021) provides a
  modern review.
...
\textbf{TODO} one argument against redundancy is that each individual
feature may not be as effective as it would be on its own because it is
not the ONLY change happening. Example is the colour and size used in
Fig 2 of letter-value plots Hofmann et al
