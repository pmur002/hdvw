...
In this chapter, we look at some basic features
...
@fig-visual-model-demo shows a data visualisation that encodes
...
We will look more at this sort of automatic decoding of information
in @sec-congruence.
...
> A data visualisation will be effective for decoding
  unusual or unique data values if the data are encoded using differences
...
The location is marked by a point where all four colours
