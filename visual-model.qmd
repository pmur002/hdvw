...
In order to understand the effectiveness of a mapping
...
We will talk about the conversion of data values to data symbols
as an **encoding** of the data values.
Later chapters will explore many different encodings.
In this chapter, we will consider the reverse operation:
the **decoding** of data symbols back to data values
(@fig-decode).
...
**position**, **angle**, **colour**, and **patterns**.[^feature-maps]
