...
The centre three coloured regions (surrounded by white circles)
show slices of constant luminance. 
Chroma increases from the centre (indicated by a white dot)
...
The coloured regions to the left and to the right (surrounded by semicircles)
...
@fig-colour-spaces provides insight into what sorts of colours and what sorts
...
for encoding qualitative data values because
we can decode differences between hues without any
