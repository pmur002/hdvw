...
can have a different effectiveness suggests that there is still more to learn
about the encoding of data values as length.
...
## Decoding length is relative {#sec-perception-relative}
