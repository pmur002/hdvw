...
from 2011 to 2021).  For the reasons outlined in @sec-encoding-visual-features
and @sec-position),
...
This chapter covers some more details about encodings that encode data values
as **length**.
...
not in close proximity (@fig-distance-effect).[^distance-effect]
